                    ...
                    <div class="col-lg-12 d-flex">
                        <div class="flex-fill">
                            <div class="contact-info-details d-flex align-items-center">
                                ...
                                <div>
                                    <h4>Call Us At</h4>
                                    <a href="tel:{{ $applicationSettings->business_number }}">{{
                                        $applicationSettings->business_number }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12 d-flex">
                        <div class="flex-fill">
                            <div class="contact-info-details d-flex align-items-center">
                                ...
                                <div>
                                    <h4>Email Us</h4>
                                    <a href="mailto:{{ $applicationSettings->business_email }}">{{
                                        $applicationSettings->business_email }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
